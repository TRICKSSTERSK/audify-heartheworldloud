      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between z-10 px-4 sm:px-0">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center lg:justify-start mb-12 lg:mb-0">
          ...
          <div className="text-center lg:text-left mt-4">
            <p className="text-sm text-gray-500 font-medium">made by sohel</p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-8">
            <button 
              ...
              className={`font-semibold py-4 px-8 rounded-full shadow-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 ${
                isStreaming 
            ...
            <button 
              ...
              className="border border-cyan-500 text-cyan-600 hover:bg-cyan-50 hover:text-cyan-700 font-semibold py-4 px-8 rounded-full shadow-md transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-200"
            >
              How It Works
            </button>
          </div>
